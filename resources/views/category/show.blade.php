				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								 @foreach($category_by_id as $prod)
								<div class="col-md-4 product-men mt-md-0 mb-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{$prod->anhdaidien}}" id="anhto1" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
												@php
                                          			$url_show1 = "/product/".$prod->id;
                                          		@endphp
													<a href="{{url($url_show1)}}" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
								...
								{{csrf_field()}}
								<fieldset>
									<input type="hidden" name="product_id_hidden" value="{{$prod->id}}" />
					...
					<div class="d-flex justify-content-center">
						<p style="text-decoration:none;">{{ $category_by_id->onEachSide(1)->links() }}</p>
					</div>
				</div>
